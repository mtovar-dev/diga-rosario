...
import Objects.Infocent.Auditar;
 ...
 * @author MITM
 */
public class Fxml_Aud_Gh_ConceptoController implements Initializable {
    ...
    @FXML
    private ComboBox<Auditar> cb_ficha;

    @FXML
    private ComboBox<String> cb_mes;

    @FXML
    private ComboBox<String> cb_nomina;

    @FXML
    private ComboBox<Integer> cb_proceso;

    @FXML
    private ComboBox<Concepto> cb_concepto;
    ...
    private static final String ScreenName = "Aud. x Concepto";
    ...
    public void initialize(URL fxmlFileLocation, ResourceBundle resources) {
        assert ap_root != null : "fx:id=\"ap_root\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert cb_ano != null : "fx:id=\"cb_ano\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert cb_empresa != null : "fx:id=\"cb_empresa\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert cb_ficha != null : "fx:id=\"cb_ficha\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert cb_mes != null : "fx:id=\"cb_mes\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert cb_nomina != null : "fx:id=\"cb_nomina\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert cb_proceso != null : "fx:id=\"cb_proceso\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert cb_concepto != null : "fx:id=\"cb_concepto\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert hbox_toolbar != null : "fx:id=\"hbox_toolbar\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert im_tool1 != null : "fx:id=\"im_tool1\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert im_tool2 != null : "fx:id=\"im_tool2\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert im_tool3 != null : "fx:id=\"im_tool3\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert im_tool4 != null : "fx:id=\"im_tool4\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert im_tool5 != null : "fx:id=\"im_tool5\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert im_tool6 != null : "fx:id=\"im_tool6\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert im_tool7 != null : "fx:id=\"im_tool7\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert im_tool8 != null : "fx:id=\"im_tool8\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert im_tool9 != null : "fx:id=\"im_tool9\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert im_tool10 != null : "fx:id=\"im_tool10\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert im_tool11 != null : "fx:id=\"im_tool11\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert im_tool12 != null : "fx:id=\"im_tool12\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert lb_screen != null : "fx:id=\"lb_screen\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert lb_Title != null : "fx:id=\"lb_Title\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert tb_asigna != null : "fx:id=\"tb_asigna\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert tb_deduc != null : "fx:id=\"tb_deduc\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert tf_buscar != null : "fx:id=\"tf_buscar\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert vb_asigna != null : "fx:id=\"vb_asigna\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert vb_deduc != null : "fx:id=\"vb_deduc\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
        assert vb_form != null : "fx:id=\"vb_form\" was not injected: check your FXML file 'Fxml_Aud_Gh_Concepto.fxml'.";
...
//            }
    ...
    */
    private void createTableAsigna(){
        ...
        this.objectWidth(col_descrip        , 180, 180); 
        this.objectWidth(col_tipo           , 44,  44); 
        this.objectWidth(col_proceso        , 180, 180);
        ...
        tb_asigna.getColumns().addAll(
                col_nomina, col_concepto, col_descrip, col_tipo,
                col_proceso, col_subproceso, col_cantidad, col_monto,
                col_saldo
                );                
    ...
    */
     ...
     */
    public void loadComboboxClear(){
        cb_ano.setValue(null);
        cb_mes.setValue(null);
        cb_nomina.setValue(null);
        cb_nomina.getItems().clear();
        cb_proceso.setValue(null);
        cb_proceso.getItems().clear();
        cb_concepto.setValue(null);
        cb_concepto.getItems().clear();
        
        tb_asigna.getItems().clear();
        tb_deduc.getItems().clear();
    }
    /**
     * Procedimiento de llenado de datos en la tabla de datos
     */
    ...
    public void loadFicha(){
        Auditar[] auditar = new Auditar[]{
            new Auditar("AS","Asignaciones"),
            new Auditar("DE","Deducciones")
        };
        final ObservableList<Auditar> data = FXCollections.observableArrayList();
        data.addAll(Arrays.asList(auditar)); 
...
//        for (int i = localCalendar.get(Calendar.MONTH) + 1; i >= 1; i--) {
     ...
     */
    private void loadNominas(Empresa empresa, int year){              
        cb_proceso.setValue(null);
        cb_concepto.setValue(null);
        tb_asigna.getItems().clear();
        tb_deduc.getItems().clear();

        String[] nominas = Ln.getInstance().loadNominas(empresa, year);
        if(nominas != null){
            final ObservableList<String> data = FXCollections.observableArrayList();
     ...
     * @param ano 
     */
    private void loadProcesosXMes(Empresa empresa, String nomina, Integer year, String month){              
        cb_concepto.setValue(null);
        ...
        Integer[] procesos = Ln.getInstance().loadTipoProcesosXMes(empresa, nomina, year, imonth);
        if(procesos != null){
     ...
     * @param tipo 
     */
    private void loadConceptos(Auditar auditar, Empresa empresa, String nomina, Integer year, String month, int type){   
        tb_asigna.getItems().clear();
        tb_deduc.getItems().clear();
        ...
        Concepto[] conceptos = Ln.getInstance().loadConceptos(auditar.getId(), empresa, nomina, year, imonth, type);
        if(conceptos != null){
     ...
     */
    private void showInfoConceptoAno(Empresa empresa, Auditar auditar, String nomina, Integer year, String month, int type, Concepto concepto){
        Integer imonth = 0;
        switch (month){
            case "Enero":
                imonth = 1;
        ...
        switch (auditar.getId()){
            case "AS":
                Asignacion[] asigna = Ln.getInstance().loadAsignacionesConceptosXMes(empresa, nomina, year, imonth, type, concepto);   
                if(asigna != null){  
                ...
                break;
            case "DE":
                Deduccion[] deduc = Ln.getInstance().loadDeduccionesConceptosXMes(empresa, nomina, year, imonth, type, concepto);   
                if(deduc != null){  
    ...
    private void init_FocusArray(int opc){
        ...
        switch(opc){
            case 0:     //SOLO LECTURA
                nodos = new Node[]{
                    cb_empresa, cb_ficha, cb_ano, cb_mes,
                    cb_nomina, cb_proceso, cb_concepto};
                break;
            case 1:     //NUEVO
                nodos = new Node[]{
                    cb_empresa, cb_ficha, cb_ano, cb_mes,
    ...
    private void init_buttons(){
         ...
         */
        cb_ficha.getSelectionModel().selectedItemProperty().addListener((ObservableValue<? extends Auditar> arg0, Auditar arg1, Auditar arg2) -> {
            if (arg2 != null)
                loadComboboxClear();
        });
        /**
        ...
        cb_ano.getSelectionModel().selectedItemProperty().addListener((ObservableValue<? extends Integer> arg0, Integer arg1, Integer arg2) -> {
            if (arg2 != null)
                loadNominas(cb_empresa.getValue(), cb_ano.getValue());
        });
        /**
         * metodo para mostrar el item (estado) seleccionado y cargar las ciudades
         * param: nombre del estado
         */
        cb_nomina.getSelectionModel().selectedItemProperty().addListener((ObservableValue<? extends String> arg0, String arg1, String arg2) -> {
            if (arg2 != null)
                loadProcesosXMes(cb_empresa.getValue(), cb_nomina.getValue(), cb_ano.getValue(), cb_mes.getValue());
        });
        /**
         * metodo para mostrar el item (estado) seleccionado y cargar las ciudades
         * param: nombre del estado
         */
        cb_proceso.getSelectionModel().selectedItemProperty().addListener((ObservableValue<? extends Integer> arg0, Integer arg1, Integer arg2) -> {
            if (arg2 != null)
                loadConceptos(cb_ficha.getValue(), cb_empresa.getValue(), cb_nomina.getValue(), cb_ano.getValue(), cb_mes.getValue(), cb_proceso.getValue());
        });
        /**
         * metodo para mostrar el item (estado) seleccionado y cargar las ciudades
         * param: nombre del estado
         */
        cb_concepto.getSelectionModel().selectedItemProperty().addListener((ObservableValue<? extends Concepto> arg0, Concepto arg1, Concepto arg2) -> {
            if (arg2 != null)
                showInfoConceptoAno(cb_empresa.getValue(), cb_ficha.getValue(), cb_nomina.getValue(), cb_ano.getValue(), cb_mes.getValue(), cb_proceso.getValue(), cb_concepto.getValue());
        });
