 ...
 * @author MITM
 */
public class Fxml_MeasureController implements Initializable {
    ...
    @FXML //  fx:id="tb_table"
    private TableView<Measure> tb_table; // Value injected by FXMLLoader
    ...
    private static final String ScreenName = "Medidas";
    ...
    public void initialize(URL fxmlFileLocation, ResourceBundle resources) {
        ...
        assert hb_1 != null : "fx:id=\"hb_1\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert hb_2 != null : "fx:id=\"hb_2\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert hb_3 != null : "fx:id=\"hb_3\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert hb_7 != null : "fx:id=\"hb_7\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert hbox_toolbar != null : "fx:id=\"hbox_toolbar\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert im_check != null : "fx:id=\"im_check\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert im_val != null : "fx:id=\"im_val\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert im_tool1 != null : "fx:id=\"im_tool1\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert im_tool10 != null : "fx:id=\"im_tool10\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert im_tool11 != null : "fx:id=\"im_tool11\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert im_tool12 != null : "fx:id=\"im_tool12\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert im_tool2 != null : "fx:id=\"im_tool2\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert im_tool3 != null : "fx:id=\"im_tool3\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert im_tool4 != null : "fx:id=\"im_tool4\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert im_tool5 != null : "fx:id=\"im_tool5\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert im_tool6 != null : "fx:id=\"im_tool6\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert im_tool7 != null : "fx:id=\"im_tool7\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert im_tool8 != null : "fx:id=\"im_tool8\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert im_tool9 != null : "fx:id=\"im_tool9\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert lb_Title != null : "fx:id=\"lb_Title\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert lb_ocultar != null : "fx:id=\"lb_ocultar\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert tb_table != null : "fx:id=\"tb_table\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert tf_abrev != null : "fx:id=\"tf_abrev\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert tf_buscar != null : "fx:id=\"tf_buscar\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert tf_id != null : "fx:id=\"tf_id\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert tf_nombre != null : "fx:id=\"tf_nombre\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert vb_form != null : "fx:id=\"vb_form\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
        assert vb_table != null : "fx:id=\"vb_form\" was not injected: check your FXML file 'Fxml_Measure.fxml'.";
...
//               }
    ...
    */
    private void createTable(){
        ...
        TableColumn col_medida      = new TableColumn("Medida");                
        ...
        this.objectWidth(col_medida     , 80, 120);
        ...
        col_status.setCellFactory(new Callback<TableColumn, TableCell>() {
            ...
            public TableCell call(TableColumn param) {
                return new TableCell<Measure, Object>() {
                    @Override
        ...
        //Se define la columna de la tabla con el nombre del atributo del objeto MEASURE correspondiente
        col_status.setCellValueFactory( 
                new PropertyValueFactory<>("status") );
        col_medida.setCellValueFactory( 
                new PropertyValueFactory<>("idMeasure") );
        ...
        tb_table.getColumns().addAll(
                col_status, col_medida, col_nombre, col_abrev);                
    ...
    private boolean saveMeasure() {
        ...
        String measurename = tf_nombre.getText();
        //Si el nombre de usuario no esta en blanco
        if(measurename != null && !measurename.equals("")){
            ...
            measure.setIdMeasure(Integer.parseInt(tf_id.getText()));
            measure.setNombre(tf_nombre.getText());
            measure.setAbrev(tf_abrev.getText());
            measure.setStatus(Datos.getMeasure().getStatus());      //Se asigna el STATUS del usuario
            //Se llama al proceso de Guardado
            boolean result = 
                    Ln.getInstance().save_Measure(measure, proceso, ScreenName);
            //Si el Resultado es correcto
            if(result){
                //Se Notifica al usuario
                Gui.getInstance().showMessage("La " + ScreenName + " se ha Guardado Correctamente!", "I");
                loadMeasures();            //Se Recarga la tabla de usuarios existentes
                return true;
            }     
        }else{                            
    ...
    private void refreshForm(){        
        tf_id.setText(String.valueOf(Datos.getMeasure().getIdMeasure()));
        tf_nombre.setText(Datos.getMeasure().getNombre());
        tf_abrev.setText(Datos.getMeasure().getAbrev());
...
//                lb_Title.setText(Tools.verticalText("EDITAR"));
    ...
    private void loadMeasures(){        
        Datos.setRep_measure(Ln.getInstance().load_Measure());
        loadTable( Datos.getRep_measure());     
    }
    /**
     * Procedimiento de llenado de datos en la tabla de datos
     */
    private void loadTable(Measure[] measures){    
        if(measures != null){
            ObservableList<Measure> data = FXCollections.observableArrayList();        
            data.addAll(Arrays.asList(measures));        
    ...
    private void selectedRow(){
        ...
        Measure measure = tb_table.getSelectionModel().getSelectedItem();          
        if(measure != null){
            Datos.setMeasure(measure);          //Asigno el Usuario a la Clase de Datos Globales
            change_im_tool4(measure.getStatus());   //Se define el valor del Boton de Cambio se Status
    ...
    private void defineToolBar() {
        ...
        //CARGA DE LA BD LA CONFIGURACION DE MEASURE PARA LA PANTALLA
            ...
            public void handle(KeyEvent ke){
                ...
                if (ke.getCode().equals(KeyCode.ENTER) || ke.getCode().equals(KeyCode.TAB)){     
                    ...
                    if(((Node)ke.getSource()).getId().equals("tf_buscar")){                        
                        try{
                            Datos.setRep_measure(Ln.getInstance().find_Measure(tf_buscar.getText()));
                            loadTable(Datos.getRep_measure());     
                        } catch(Exception e){
    ...
    private void botonInicio() {
        ...
        Datos.setMeasure(new Measure());                           
        refreshForm();                      
        Datos.setMeasure(null);             //RESET DE LA VARIABLE
    ...
    private void botonEditar(){
        if(Datos.getMeasure()!= null && toolsConfig[3]==1){
            tipoOperacion = 2;
            change_im_tool4(Datos.getMeasure().getStatus());
            refreshForm();
            setFormVisible(true);     
            Gui.getFields()[Gui.getFieldFocused()].requestFocus();
        }
    ...
    private void botonGuardar(){        
        if(Datos.getMeasure()!= null && toolsConfig[4]==1){
            boolean result = saveMeasure();
            if (result)
                botonInicio();
        }
    }
    ...
    private void botonEliminar() {
        if(Datos.getMeasure()!= null && toolsConfig[5]==1){
            tipoOperacion = 4;      //OPERACION DE BORRADO
            //changeIcon(true);       //SE CAMBIA EL ICONO DE VERIFICACION DEL MEASURE                   
            refreshForm();         
            setFormVisible(true);  
            String verbo = "desactivar";
            if(Datos.getMeasure().getStatus() == 1){
                verbo = "activar";
            }
            String mensj = 
                "¿Seguro que desea " + verbo + " la " + ScreenName + " " + Datos.getMeasure().getIdMeasure() + " ?";
    ...
    private void botonOcultar(){
        ...
        Datos.setMeasure(new Measure());                           
        refreshForm();                      
        Datos.setMeasure(new Measure());    //RESET DE LA VARIABLE
        setFormVisible(false);              //OCULTA EL FORMULARIO
    }
    /**
     * 
    ...
    private void change_im_val(int boo){
        // 200 HTTP_request Ok
        if(boo == 200){    //IMAGEN SI EL MEASURE ES CORRECTO
    ...
    private void change_im_tool4(int boo){
        if(boo == 0){   //IMAGEN SI EL MEASURE ESTA INHABILITADO
            im_tool4.setImage(new Image(getClass().getResourceAsStream("/Images/img07.png")));
        }else{          //IMAGEN PARA HABILITAR AL MEASURE
