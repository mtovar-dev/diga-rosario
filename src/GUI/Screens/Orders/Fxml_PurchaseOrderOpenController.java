 ...
 * @author MITM
 */
public class Fxml_PurchaseOrderOpenController implements Initializable {
...
//            }
    ...
    */
    private void createDetail(){
        ...
        this.objectWidth(col_descrip        , 230, 300);
        this.objectWidth(col_unidped        , 45,  45);
        this.objectWidth(col_cantped        , 65 , 65);
        this.objectWidth(col_cantrec        , 65 , 65);
        this.objectWidth(col_cantpen        , 65 , 65);
        this.objectWidth(col_precio         , 65,  65);
        ...
        tb_view.getColumns().addAll(
                col_orden, col_producto, col_descrip, col_unidped,
